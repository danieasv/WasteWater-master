...
"));
  ...
  class BenchPlant "COST Benchmark WWTP Configuration"
    ...
    ASM1.nitri tank5(V=1333,
      ...
      K_x_T=0.1,
      K_s=10,
      ny_h=0.8)              annotation (Placement(transformation(extent={{-6,
              -6},{14,14}})));
    ASM1.nitri tank4(V=1333,
      ...
      K_x_T=0.1,
      K_s=10,
      ny_h=0.8)              annotation (Placement(transformation(extent={{-32,
              -6},{-12,14}})));
    ASM1.nitri tank3(V=1333,
      ...
      K_s=10,
      ny_h=0.8,
      de=4.5)                annotation (Placement(transformation(extent={{-60,
              -6},{-40,14}})));
    ASM1.deni tank2(
      i_xb=0.08,
      b_h_T=0.3,
      ...
      K_x_T=0.1,
      K_s=10,
      ny_h=0.8)     annotation (Placement(transformation(extent={{-48,22},{-28,
              42}})));
    ASM1.deni tank1(
      i_xb=0.08,
      b_h_T=0.3,
      ...
      K_x_T=0.1,
      K_s=10,
      ny_h=0.8)     annotation (Placement(transformation(extent={{-76,22},{-56,
              42}})));
    ASM1.mixer3 mixer annotation (Placement(transformation(extent={{-104,22},{
              -84,42}})));
    Modelica.Blocks.Sources.CombiTimeTable CombiTableTime(
  ...
  equation
    ...
    connect(sensor_NO.In, tank2.MeasurePort) annotation (Line(points={{-32,48},
            {-32,36.5},{-32.5,36.5}}));
    connect(blower1.AirOut, tank3.AirIn) annotation (Line(points={{-51,-42},{
            -51,-24},{-50,-24},{-50,-5.8}}));
    connect(blower2.AirOut, tank4.AirIn) annotation (Line(points={{-23,-42},{
            -23,-24},{-22,-24},{-22,-5.8}}));
    connect(blower3.AirOut, tank5.AirIn) annotation (Line(points={{3,-42},{3,
            -24},{4,-24},{4,-5.8}}));
    connect(Feedback.y, PI1.u) annotation (Line(points={{81,50},{86,50}}));
    ...
    connect(Temperature.y, tank2.T)
      annotation (Line(points={{-81.4,56},{-52,56},{-52,36},{-48,36}}, color={0,
            0,255}));
    connect(Temperature.y, tank3.T) annotation (Line(points={{-81.4,56},{-52,56},
            {-52,14},{-60,14},{-60,8},{-59.5,8},{-60,8}},               color={
            0,0,255}));
    connect(Temperature.y, tank4.T) annotation (Line(points={{-81.4,56},{-52,56},
            {-52,14},{-32,14},{-32,8}}, color={0,0,255}));
    connect(Temperature.y, tank5.T) annotation (Line(points={{-81.4,56},{-52,56},
            {-52,14},{-5.9,14},{-5.9,8},{-6,8}},   color={0,0,255}));
...
"));
  ...
  class BenchPlant_BSM1 "COST Benchmark WWTP Configuration"
    import WasteWater;
    ...
    ASM1.pump RecyclePump(Q_max=55338) annotation (Placement(transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=180)));
    Modelica.Blocks.Sources.Constant NitrogenSetpoint(k=55338)
                                                      annotation (Placement(
          transformation(extent={{-103,-66},{-83,-46}})));
    ASM1.pump ReturnPump(Q_max=18446) annotation (Placement(transformation(
          origin={26,-26},
          extent={{-10,-10},{10,10}},
          rotation=180)));
    ...
    WasteWater.ASM1.sensor_TKN sensor_TKN1 annotation (Placement(transformation(
            extent={{97,14},{113,30}})));
    WasteWater.ASM1.sensor_COD sensor_COD1 annotation (Placement(transformation(
            extent={{119,38},{135,54}})));
    WasteWater.ASM1.sensor_TSS sensor_TSS1 annotation (Placement(transformation(
            extent={{32,15},{48,30}})));
    WasteWater.ASM1.WWSource2 wWSource2_1
      annotation (Placement(transformation(extent={{-59,78},{-39,98}})));
    WasteWater.ASM1.nitri5 tank5
    ...
    WasteWater.ASM1.WWSource
                  WWSource annotation (Placement(transformation(extent={{-85,78},
              {-65,98}})));
    ASM1.SludgeSink WasteSludge1
                                annotation (Placement(transformation(extent={{-23,74},
              {-3,94}})));
  equation
    connect(divider.Out1, Settler.Feed) annotation (Line(points={{40,6.6},{44,
            6.6},{44,6.4},{48,6.4}}));
    ...
    connect(sensor_TKN1.In, Settler.Effluent) annotation (Line(points={{105,14},
            {105,10.7},{68.2,10.7}}));
    connect(sensor_COD1.In, Settler.Effluent) annotation (Line(points={{127,38},
            {127,10.7},{68.2,10.7}}));
    connect(Effluent.In, Settler.Effluent) annotation (Line(points={{88,-16},{
            78.5,-16},{78.5,10.7},{68.2,10.7}}));
    connect(Constant2.y, ReturnPump.u)
    ...
    connect(NitrogenSetpoint.y, RecyclePump.u) annotation (Line(
        points={{-82,-56},{-66,-56},{-66,-14.5},{-75.1,-14.5}},
        color={0,0,127},
        smooth=Smooth.None));
...
"),   experiment(
  ...
  class BenchPlant_BSM1_2c "COST Benchmark WWTP Configuration"
    import WasteWater;
  ...
  equation
    ...
    connect(tank4.Out, tank5.In) annotation (Line(
        ...
        smooth=Smooth.None));
    connect(tank5.Out, divider.In) annotation (Line(
        points={{15,4},{18,4},{18,4.3},{20,4.3}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(sensor_O2.In, tank5.MeasurePort) annotation (Line(
        points={{9.5,25},{9.5,8.5},{10.5,8.5}},
        color={0,0,255},
        smooth=Smooth.None));
    annotation (
      Diagram(coordinateSystem(
...
"),   experiment(
        ...
        __Dymola_Algorithm=""),
      __Dymola_experimentSetupOutput);
  end BenchPlant_BSM1_2c;

  class BenchPlant_BSM1_2d "COST Benchmark WWTP Configuration"
    import WasteWater;
    ...
    ASM1.nitri tank4(V=1333,
      ...
      K_x_T=0.1,
      K_s=10,
      ny_h=0.8)              annotation (Placement(transformation(extent={{-33,-6},
              {-13,14}})));
    ASM1.nitri tank3(V=1333,
      i_xb=0.08,
      b_h_T=0.3,
    ...
    ASM1.sensor_NO sensor_NO annotation (Placement(transformation(extent={{-42,
              48},{-22,68}})));
    ASM1.sensor_O2 sensor_O2 annotation (Placement(transformation(extent={{12,38},
              {29,55}})));
    ASM1.pump RecyclePump(Q_max=55338) annotation (Placement(transformation(
          origin={-85,-19},
          extent={{-10,-10},{10,10}},
    ...
    ASM1.SludgeSink WasteSludge1
                                annotation (Placement(transformation(extent={{-23,74},
              {-3,94}})));
    WasteWater.ASM1.Aeration_energy Aeration_Energy_AE
      annotation (Placement(transformation(extent={{-6,18},{14,38}})));
    WasteWater.ASM1.nitri5c tank5
      annotation (Placement(transformation(extent={{-7,-6},{13,14}})));
    WasteWater.ASM1.Effluent_Quality_EQ Effluent_Quality_EQ
      annotation (Placement(transformation(extent={{68,50},{88,70}})));
    WasteWater.ASM1.Influent_Quality_IQ influent_Quality_IQ
      annotation (Placement(transformation(extent={{-84,50},{-64,70}})));
    WasteWater.ASM1.Pumping_energy_PE pumping_energy_PE
      annotation (Placement(transformation(extent={{-29,-67},{-9,-47}})));
  ...
  equation
    connect(divider.Out1, Settler.Feed) annotation (Line(points={{40,6.6},{44,
            6.6},{44,6.4},{48,6.4}}));
    connect(tank3.Out, tank4.In) annotation (Line(points={{-40,4},{-33,4}}));
    connect(tank3.In, tank2.Out) annotation (Line(points={{-60,4},{-70,4},{-70,
            18},{-18,18},{-18,32},{-28,32}},
        color={0,0,0},
        smooth=Smooth.None));
    ...
    connect(sensor_NO.In, tank2.MeasurePort) annotation (Line(points={{-32,48},
            {-32,36.5},{-32.5,36.5}}));
    connect(RecyclePump.Out, mixer.In3) annotation (Line(points={{-95,-21.8},{
            -104,-21.8},{-104,27.5}}));
    connect(Settler.Return, ReturnPump.In) annotation (Line(points={{55,-4.6},{
            55,-22.7},{36,-22.7}}));
    connect(WastePump.Out, WasteSludge.In) annotation (Line(points={{79,-42.2},
    ...
    connect(sensor_TKN1.In, Settler.Effluent) annotation (Line(points={{105,14},
            {105,10.7},{68.2,10.7}}));
    connect(sensor_COD1.In, Settler.Effluent) annotation (Line(points={{115,41},
            {115,10.7},{68.2,10.7}}));
    connect(Effluent.In, Settler.Effluent) annotation (Line(points={{88,-16},{
            78.5,-16},{78.5,10.7},{68.2,10.7}}));
    connect(Constant2.y, ReturnPump.u)
    ...
    connect(NitrogenSetpoint.y, RecyclePump.u) annotation (Line(
        points={{-82,-56},{-66,-56},{-66,-21.5},{-76.1,-21.5}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(CombiTableTime.y,WWSource. data)
      annotation (Line(points={{-90,88},{-84,88}}));
    ...
    connect(wWSource2_1.Out, WasteSludge1.In) annotation (Line(
        ...
        color={0,0,0},
        smooth=Smooth.None));
    connect(tank4.Kla, Aeration_Energy_AE.Kla4) annotation (Line(
        points={{-24.8,8},{-20,8},{-20,11},{-11,11},{-11,27},{-5,27},{-5,28},{
            -3.4,28}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(tank3.Kla, Aeration_Energy_AE.Kla3) annotation (Line(
        points={{-51.8,8},{-52,8},{-52,15},{-15,15},{-15,32},{-3.4,32}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(tank4.Out, tank5.In) annotation (Line(
        points={{-13,4},{-7,4}},
        ...
        smooth=Smooth.None));
    connect(tank5.Out, divider.In) annotation (Line(
        points={{13,4},{17,4},{17,4.3},{20,4.3}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(tank5.Kla, Aeration_Energy_AE.Kla5) annotation (Line(
        points={{1.2,8},{1.2,16},{-3.4,16},{-3.4,24}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(tank5.MeasurePort, sensor_O2.In) annotation (Line(
        points={{8.5,8.5},{8.5,14},{20,14},{20,38},{20.5,38}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(Effluent_Quality_EQ.In, Settler.Effluent) annotation (Line(
        points={{78,50},{79,50},{79,11},{68.2,10.7}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(influent_Quality_IQ.In, mixer.In1) annotation (Line(
        points={{-74,50},{-108,50},{-108,35.5},{-104,35.5}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(WastePump.In, sensor_Q2.Out) annotation (Line(
        points={{59,-48.3},{56,-48.3},{56,-55},{78,-55},{78,-68},{72,-68}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(Settler.Waste, sensor_Q2.In) annotation (Line(
        points={{61,-4.6},{66,-4.6},{66,-29},{50,-29},{50,-68},{52,-68}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(sensor_Q2.Q, pumping_energy_PE.Qw) annotation (Line(
        points={{62,-77.8},{-35,-77.8},{-35,-61},{-26.4,-61}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(RecyclePump.In, sensor_Q.Out) annotation (Line(
        points={{-75,-15.7},{-60,-15.7},{-60,-18},{-46,-18}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(sensor_Q.In, divider.Out2) annotation (Line(
        points={{-26,-18},{45,-18},{45,2.5},{40,2.5}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(sensor_Q1.In, ReturnPump.Out) annotation (Line(
        points={{1,-31},{9,-31},{9,-28.8},{16,-28.8}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(sensor_Q1.Out, mixer.In2) annotation (Line(
        points={{-19,-31},{-109,-31},{-109,31.5},{-104,31.5}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(sensor_Q.Q, pumping_energy_PE.Qa) annotation (Line(
        points={{-36,-27.8},{-36,-53},{-26.4,-53}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(sensor_Q1.Q, pumping_energy_PE.Qr) annotation (Line(
        points={{-9,-40.8},{-42,-40.8},{-42,-57},{-26.4,-57}},
        color={0,0,127},
        smooth=Smooth.None));
...
"),   experiment(
        ...
        __Dymola_Algorithm=""),
      __Dymola_experimentSetupOutput);
  end BenchPlant_BSM1_2d;

  class BenchPlant_BSM1_3 "COST Benchmark WWTP Configuration"
    import WasteWater;
    ...
    ASM1.SecClarModTakacs Settler annotation (Placement(transformation(extent={
              {48,-5},{68,15}})));
    ASM1.divider2 divider annotation (Placement(transformation(extent={{19,-6},
              {39,14}})));
    ASM1.nitri tank4(V=1333,
      i_xb=0.08,
      b_h_T=0.3,
    ...
    WasteWater.ASM1.WWSource
              ...
              {-65,98}})));
    ASM1.SludgeSink WasteSludge1
                                annotation (Placement(transformation(extent={{-36,72},
              {-16,92}})));
    WasteWater.ASM1.Aeration_energy Aeration_Energy_AE
      annotation (Placement(transformation(extent={{33,76},{53,96}})));
    WasteWater.ASM1.Effluent_Quality_EQ Effluent_Quality_EQ
      annotation (Placement(transformation(extent={{68,50},{88,70}})));
    WasteWater.ASM1.Influent_Quality_IQ influent_Quality_IQ
      annotation (Placement(transformation(extent={{-84,50},{-64,70}})));
    ...
    WasteWater.ASM1.Overall_Cost_Indicator overall_Cost_Indicator
      annotation (Placement(transformation(extent={{69,81},{89,101}})));
  equation
    ...
    connect(wWSource2_1.Out, WasteSludge1.In) annotation (Line(
        points={{-39.2,81},{-31,81},{-31,80.8},{-36,80.8}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(Effluent_Quality_EQ.In, Settler.Effluent) annotation (Line(
        points={{78,50},{79,50},{79,11},{68.2,10.7}},
    ...
    connect(RecyclePump.In, sensor_Q.Out) annotation (Line(
        ...
        smooth=Smooth.None));
    connect(sensor_Q.In, divider.Out2) annotation (Line(
        points={{-26,-18},{45,-18},{45,2.5},{39,2.5}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(sensor_Q1.In, ReturnPump.Out) annotation (Line(
        points={{1,-31},{9,-31},{9,-28.8},{16,-28.8}},
...
"),   experiment(
        ...
        __Dymola_Algorithm=""),
      __Dymola_experimentSetupOutput);
  end BenchPlant_BSM1_3;

  class BenchPlant_BSM1_9 "COST Benchmark WWTP Configuration"
    import WasteWater;
    ...
    ASM1.SludgeSink WasteSludge annotation (Placement(transformation(extent={{
              87,-51},{107,-31}})));
    WasteWater.ASM1.Settler_New_task9
                          Settler "Settler Task9"
  ...
  equation
    ...
    connect(WastePump.In, sensor_Q2.Out) annotation (Line(
        ...
        smooth=Smooth.None));
    connect(Settler.Waste, sensor_Q2.In) annotation (Line(
        points={{67,2},{69,2},{69,-29},{50,-29},{50,-68},{52,-68}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(sensor_Q2.Q, pumping_energy_PE.Qw) annotation (Line(
        points={{62,-77.8},{-35,-77.8},{-35,-61},{-26.4,-61}},
    ...
    connect(Settler.Recycle, ReturnPump.In) annotation (Line(points={{67,5},{74,
